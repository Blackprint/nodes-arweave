module.exports = {
	...
	js:{
		file:'@cwd/dist/nodes-arweave.mjs', // @cwd = directory where you start the Node.js
	...
	// sf:{
	// 	file:'@cwd/dist/nodes-arweave.sf', // will have sf.css and sf.mjs
